...
cp ../data/output/posteriors/individual/* /lustre/haven/proj/UTK0105/Python_runs/aaa/posteriors/
cp ../figures/* /lustre/haven/proj/UTK0105/Python_runs/aaa/figures/
cp ../data/output/medians/* /lustre/haven/proj/UTK0105/Python_runs/aaa/params/
